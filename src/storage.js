...
// This significantly improves performance for large dictionaries.
let memoryCache = null;

// Listen for storage events to invalidate the cache if changes occur in another tab
...
export function saveDictionary(mapping) {
  memoryCache = mapping; // Update cache
  const data = {
    version: APP_VERSION,
    mapping: mapping
  };
